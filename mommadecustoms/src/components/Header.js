    ...
    render() {
        return (
              ...
              <Navbar.Text>
            {
              this.props.username
              ? <div>
                  Signed in as: <br/>{this.props.username} <br/>
                  <button onClick={this.logoutUser}>Logout</button>
                  <Nav.Link onClick={() => this.props.setPage('cart')}>
                    <img
                        alt=""
              ...
              <Nav className="justify-content-end">
                <Nav.Link onClick={() => this.props.setPage('register')} id='signup'>Register</Nav.Link>
